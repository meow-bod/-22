...
export default function NewBookingPage() {
  ...
  return (
    <div className="container mx-auto p-8 max-w-lg">
      <h1 className="text-3xl font-bold mb-6">向 {sitter.users.full_name} 提出預約</h1>
      <form onSubmit={handleBooking} className="space-y-6 bg-white p-8 shadow-md rounded-lg">
        <div>
          <label htmlFor="start-date" className="block text-sm font-medium text-gray-700">開始時間</label>
          <input
            type="datetime-local"
            id="start-date"
            value={startDate}
        ...
        <div>
          <label htmlFor="end-date" className="block text-sm font-medium text-gray-700">結束時間</label>
          <input
            type="datetime-local"
            id="end-date"
            value={endDate}
